...
public class TouchableSpan extends ClickableSpan {
     ...
     * @param link
     */
    public TouchableSpan(Link link, TextView textView) {
        this.link = link;
    ...
    public void updateDrawState(TextPaint ds) {
        ...
        /**Hoang Le update*/
        ds.setTextSize(link.getTextSize() * ds.density > textView.getTextSize() ? link.getTextSize() * ds.density : textView.getTextSize());
